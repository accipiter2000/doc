...
<script>
	...
	function _preInsertTag() {//新增
		...
		win = Ext.create('Ext.window.Window', {
			...
			width : 800,
			height : '80%',
			html : '<iframe src="preInsertTag.do" style="width: 100%; height: 100%;" frameborder="0"></iframe>',
			listeners : {
	...
	function _preUpdateTag() {//修改
		...
		win = Ext.create('Ext.window.Window', {
			...
			width : 800,
			height : '80%',
			html : '<iframe src="preUpdateTag.do?TAG_ID_=' + records[0].get('TAG_ID_') + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>',
			listeners : {
				'close' : function(panel, eOpts) {
					if (returnValue != null) {//更新页面数据
						var tag = returnValue;
