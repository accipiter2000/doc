...
<title><spring:message code="view" /><spring:message code="CODE" /></title>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="view" /><spring:message code="CODE" /><br /><br /><spring:message code="help.viewCode" />'
							});
						}
					}
				} ],
