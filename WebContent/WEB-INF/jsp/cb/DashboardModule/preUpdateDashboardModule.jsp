...
<title><spring:message code="update" /><spring:message code="DASHBOARD_MODULE" /></title>
...
<script>
		...
		var dashboardModuleFormPanel = Ext.create('Ext.form.Panel', {//表单
			...
			dockedItems : [ {//所属按钮面板
				...
				items : [ {
					...
					handler : _updateDashboardModule
				}, {
					xtype : 'button',
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="DASHBOARD_MODULE" /><br /><br /><spring:message code="help.updateDashboardModule" />'
							});
						}
					}
				} ],
	...
	function _updateDashboardModule() {//修改
		Ext.getCmp('dashboardModuleFormPanel').getForm().submit({//提交表单
			url : 'updateDashboardModule.do',
