...
<script>
	...
	Ext.onReady(function() {
		...
		var dutyStore = Ext.create('Ext.data.Store', {//表格数据
			...
			pageSize : -1,
			fields : [ 'DUTY_ID_', 'ORGN_SET_ID_', 'DUTY_CODE_', 'DUTY_NAME_', 'CATEGORY_', 'MEMO_', 'DUTY_TAG_', 'ORDER_', 'DUTY_STATUS_', 'CREATION_DATE_', 'UPDATE_DATE_', 'OPERATOR_ID_', 'OPERATOR_NAME_', 'ORGN_SET_CODE_', 'ORGN_SET_NAME_' ],
			proxy : {
				url : 'selectOmDuty.do',
				type : 'ajax',
				async : true,//false为同步
