...
<title><spring:message code="update" /><spring:message code="ORG" /></title>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="ORG" /><br /><br /><spring:message code="help.updateOrg" />'
							});
						}
					}
				} ],
