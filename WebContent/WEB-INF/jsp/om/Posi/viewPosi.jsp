...
<title><spring:message code="view" /><spring:message code="POSI" /></title>
	...
	Ext.onReady(function() {
		...
		var posiFormPanel = Ext.create('Ext.form.Panel', {//表单
			...
			items : [ {
				...
				xtype : 'textfield',
				name : 'ORG_ID_',
				fieldLabel : '<spring:message code="POSI.ORG_ID_" />',
				maxLength : 40,
				allowBlank : false
			}, {
				xtype : 'textfield',
				...
				xtype : 'combo',
				name : 'POSI_STATUS_',
				store : POSI_STATUS_CodeStore,
				queryMode : 'local',
				valueField : 'CODE_',
				displayField : 'NAME_',
				forceSelection : true,
				fieldLabel : '<spring:message code="POSI.POSI_STATUS_" />',
				allowBlank : false
			}, {
				xtype : 'datefield',
				name : 'CREATION_DATE_',
				...
				fieldLabel : '<spring:message code="POSI.CREATION_DATE_" />',
				allowBlank : true
			}, {
				xtype : 'datefield',
				name : 'UPDATE_DATE_',
				format : 'Y-m-d H:i:s',
				submitFormat : 'Y-m-d H:i:s',
				fieldLabel : '<spring:message code="POSI.UPDATE_DATE_" />',
				allowBlank : true
			}, {
				xtype : 'textfield',
				name : 'OPERATOR_NAME_',
				fieldLabel : '<spring:message code="POSI.OPERATOR_NAME_" />',
				maxLength : 20,
				allowBlank : true
			} ],
			dockedItems : [ {//所属按钮面板
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="view" /><spring:message code="POSI" /><br /><br /><spring:message code="help.viewPosi" />'
							});
						}
					}
				} ],
