...
<title><spring:message code="update" /><spring:message code="DUTY" /></title>
...
<script>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="DUTY" /><br /><br /><spring:message code="help.updateDuty" />'
							});
						}
					}
				} ],
	...
	function _updateDuty() {//修改
		Ext.getCmp('dutyFormPanel').getForm().submit({//提交表单
			url : 'updateOmDuty.do',
			submitEmptyText : false,
			waitMsg : '<spring:message code="processing" />',
			success : function(form, action) {
				var data = action.result;
				parent.returnValue = data.duty;
