...
<title><spring:message code="update" /><spring:message code="EMP" /></title>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="EMP" /><br /><br /><spring:message code="help.updateEmp" />'
							});
						}
					}
				} ],
