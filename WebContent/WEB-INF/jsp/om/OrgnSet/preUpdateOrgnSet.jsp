...
<title><spring:message code="update" /><spring:message code="ORGN_SET" /></title>
...
<script>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="ORGN_SET" /><br /><br /><spring:message code="help.updateOrgnSet" />'
							});
						}
					}
				} ],
	...
	function _updateOrgnSet() {//修改
		Ext.getCmp('orgnSetFormPanel').getForm().submit({//提交表单
			url : 'updateOmOrgnSet.do',
