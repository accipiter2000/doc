...
<script>
	...
	//获取url中的入参
	var BASE_ORGN_SET_ID_ = null;
	if (location.href.split('?')[1] != undefined) {
		var parameters = Ext.urlDecode(location.href.split('?')[1]);
		(parameters.BASE_ORGN_SET_ID_ != undefined) ? BASE_ORGN_SET_ID_ = parameters.BASE_ORGN_SET_ID_ : 0;
	}
	...
	Ext.onReady(function() {
		...
		var orgnSetStore = Ext.create('Ext.data.Store', {
			...
			proxy : {
				...
				extraParams : {
					'PARENT_ORGN_SET_ID_' : BASE_ORGN_SET_ID_
				},
				reader : {
					type : 'json',
					root : 'orgnSetList',
		...
		var empRelationStore = Ext.create('Ext.data.Store', {
			...
			loading : false,//自动加载时必须为true
			pageSize : -1,
			fields : [ 'OPERATION_', 'ORGN_SET_ID_', 'ORGN_SET_CODE_', 'ORGN_SET_NAME_', 'EMP_RELATION_ID_', 'EMP_RELATION_', 'EMP_RELATION_CATEGORY_', 'MEMO_', 'EMP_RELATION_TAG_', 'EMP_RELATION_EXT_ATTR_1_', 'EMP_RELATION_EXT_ATTR_2_', 'EMP_RELATION_EXT_ATTR_3_', 'EMP_RELATION_EXT_ATTR_4_', 'EMP_RELATION_EXT_ATTR_5_', 'EMP_RELATION_EXT_ATTR_6_', 'EMP_RELATION_EXT_ATTR_7_', 'EMP_RELATION_EXT_ATTR_8_', 'ORDER_', 'EMP_RELATION_STATUS_', 'CREATION_DATE_', 'UPDATE_DATE_', 'OPERATOR_ID_', 'OPERATOR_NAME_', 'UPPER_EMP_ID_', 'UPPER_EMP_CODE_', 'UPPER_EMP_NAME_', 'UPPER_PASSWORD_RESET_REQ_', 'UPPER_PARTY_', 'UPPER_EMP_LEVEL_', 'UPPER_GENDER_', 'UPPER_BIRTH_DATE_', 'UPPER_TEL_', 'UPPER_EMAIL_', 'UPPER_IN_DATE_', 'UPPER_OUT_DATE_', 'UPPER_EMP_CATEGORY_', 'UPPER_MEMO_', 'UPPER_EMP_TAG_', 'UPPER_EMP_EXT_ATTR_1_', 'UPPER_EMP_EXT_ATTR_2_', 'UPPER_EMP_EXT_ATTR_3_', 'UPPER_EMP_EXT_ATTR_4_', 'UPPER_EMP_EXT_ATTR_5_', 'UPPER_EMP_EXT_ATTR_6_', 'UPPER_EMP_EXT_ATTR_7_', 'UPPER_EMP_EXT_ATTR_8_', 'UPPER_ORDER_', 'UPPER_EMP_STATUS_', 'UPPER_CREATION_DATE_', 'UPPER_UPDATE_DATE_', 'UPPER_OPERATOR_ID_', 'UPPER_OPERATOR_NAME_', 'UPPER_ORG_ID_', 'UPPER_PARENT_ORG_ID_', 'UPPER_ORG_CODE_', 'UPPER_ORG_NAME_', 'UPPER_ORG_ABBR_NAME_', 'UPPER_ORG_TYPE_', 'UPPER_ORG_CATEGORY_', 'UPPER_ORG_TAG_', 'UPPER_ORG_EXT_ATTR_1_', 'UPPER_ORG_EXT_ATTR_2_', 'UPPER_ORG_EXT_ATTR_3_', 'UPPER_ORG_EXT_ATTR_4_', 'UPPER_ORG_EXT_ATTR_5_', 'UPPER_ORG_EXT_ATTR_6_', 'UPPER_ORG_EXT_ATTR_7_', 'UPPER_ORG_EXT_ATTR_8_', 'UPPER_ORG_STATUS_', 'UPPER_PARENT_ORG_CODE_', 'UPPER_PARENT_ORG_NAME_', 'LOWER_EMP_ID_', 'LOWER_EMP_CODE_', 'LOWER_EMP_NAME_', 'LOWER_PASSWORD_RESET_REQ_', 'LOWER_PARTY_', 'LOWER_EMP_LEVEL_', 'LOWER_GENDER_', 'LOWER_BIRTH_DATE_', 'LOWER_TEL_', 'LOWER_EMAIL_', 'LOWER_IN_DATE_', 'LOWER_OUT_DATE_', 'LOWER_EMP_CATEGORY_', 'LOWER_MEMO_', 'LOWER_EMP_TAG_', 'LOWER_EMP_EXT_ATTR_1_', 'LOWER_EMP_EXT_ATTR_2_', 'LOWER_EMP_EXT_ATTR_3_', 'LOWER_EMP_EXT_ATTR_4_', 'LOWER_EMP_EXT_ATTR_5_', 'LOWER_EMP_EXT_ATTR_6_', 'LOWER_EMP_EXT_ATTR_7_', 'LOWER_EMP_EXT_ATTR_8_', 'LOWER_ORDER_', 'LOWER_EMP_STATUS_', 'LOWER_CREATION_DATE_', 'LOWER_UPDATE_DATE_', 'LOWER_OPERATOR_ID_', 'LOWER_OPERATOR_NAME_', 'LOWER_ORG_ID_', 'LOWER_PARENT_ORG_ID_', 'LOWER_ORG_CODE_', 'LOWER_ORG_NAME_', 'LOWER_ORG_ABBR_NAME_', 'LOWER_ORG_TYPE_', 'LOWER_ORG_CATEGORY_', 'LOWER_ORG_TAG_', 'LOWER_ORG_EXT_ATTR_1_', 'LOWER_ORG_EXT_ATTR_2_', 'LOWER_ORG_EXT_ATTR_3_', 'LOWER_ORG_EXT_ATTR_4_', 'LOWER_ORG_EXT_ATTR_5_', 'LOWER_ORG_EXT_ATTR_6_', 'LOWER_ORG_EXT_ATTR_7_', 'LOWER_ORG_EXT_ATTR_8_', 'LOWER_ORG_STATUS_', 'LOWER_PARENT_ORG_CODE_', 'LOWER_PARENT_ORG_NAME_' ]
		});
		...
		var buttonPanel = Ext.create('Ext.Panel', {//按钮
			...
			items : [ {
				xtype : 'button',
				text : '<spring:message code="copy" />',
				icon : 'image/icon/transferIn.png',
				handler : _copyOrgnSet
			}, {
				xtype : 'button',
				text : '<spring:message code="compare" />',
				icon : 'image/icon/associate.png',
				handler : _compareOrgnSet
			}, {
				xtype : 'button',
				text : '<spring:message code="replace" />',
				icon : 'image/icon/refresh.png',
				handler : _replaceOrgnSet
			}, {
				xtype : 'button',
		...
		var orgnSetPanel = Ext.create('Ext.grid.Panel', {//表格
			id : 'orgnSetPanel',
			store : orgnSetStore,
	...
	function _copyOrgnSet() {//修改
		...
		Ext.MessageBox.show({
			...
			msg : '<spring:message code="copy" />',
			buttons : Ext.MessageBox.YESNO,
			icon : Ext.MessageBox.QUESTION,
			fn : function(btn) {
				if (btn == 'yes') {
					Ext.Ajax.request({
						url : 'copyOmOrgnSet.do',
						async : false,
						params : {
							'BASE_ORGN_SET_ID_' : BASE_ORGN_SET_ID_,
