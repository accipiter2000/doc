...
<script>
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="DOC_TYPE" /><br /><br /><spring:message code="help.updateDocTypeHtml" />'
							});
						}
					}
				} ],
	...
	function _updateHtml() {//修改
		Ext.getCmp('docTypeFormPanel').getForm().submit({//提交表单
			url : 'updateDocTypeHtml.do',
