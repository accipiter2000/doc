	...
	Ext.onReady(function() {
		...
		var docTypeFormPanel = Ext.create('Ext.form.Panel', {//表单
			...
			items : [ {
				...
				xtype : 'textfield',
				name : 'TEMPLATE_FILE_NAME_',
				fieldLabel : '<spring:message code="DOC_TYPE.TEMPLATE_FILE_" />',
				width : '81%',
				allowBlank : true
			}, {
				hidden : docType.TEMPLATE_FILE_LENGTH_ == 0,
				xtype : 'button',
				text : '<spring:message code="view" />',
				width : 80,
				handler : function() {
					location.href = 'loadTemplateFile.do?DOC_TYPE_ID_=' + DOC_TYPE_ID_;
				}
			}, {
				xtype : 'textareafield',
				name : 'HTML_',
				fieldLabel : '<spring:message code="DOC_TYPE.HTML_" />',
				width : '92%',
				height : 280,
				allowBlank : true
			}, {
				xtype : 'textareafield',
				name : 'BOOKMARK_',
				fieldLabel : '<spring:message code="DOC_TYPE.BOOKMARK_" />',
				width : '92%',
				height : 280,
				allowBlank : true
			}, {
				...
				fieldLabel : '<spring:message code="DOC_TYPE.CREATION_DATE_" />',
				allowBlank : true
			}, {
				xtype : 'datefield',
				name : 'UPDATE_DATE_',
				format : 'Y-m-d H:i:s',
				submitFormat : 'Y-m-d H:i:s',
				fieldLabel : '<spring:message code="DOC_TYPE.UPDATE_DATE_" />',
				allowBlank : true
			}, {
				xtype : 'textfield',
				name : 'OPERATOR_NAME_',
				fieldLabel : '<spring:message code="DOC_TYPE.OPERATOR_NAME_" />',
				maxLength : 20,
				allowBlank : true
			} ],
			dockedItems : [ {//所属按钮面板
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="view" /><spring:message code="DOC_TYPE" /><br /><br /><spring:message code="help.viewDocType" />'
							});
						}
					}
				} ],
