...
<title><spring:message code="update" />HTML</title>
...
<script>
	...
	Ext.onReady(function() {
		...
		if (DOC_TYPE_ID_ != null && DOC_TYPE_ID_ != '') {
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" />HTML<br /><br /><spring:message code="help.updateTemplateHtml" />'
							});
						}
					}
				} ],
	...
	function _init() {//初始化。页面和所有自动加载数据全部加载完成后调用。
		...
		if (DOC_TYPE_ID_ != null && DOC_TYPE_ID_ != '' && docType == null) {//检查被修改对象是否加载成功
	...
	function _updateTemplateHtml() {//修改
		Ext.getCmp('docTypeFormPanel').getForm().submit({//提交表单
			url : 'updateDocTypeTemplateHtml.do',
