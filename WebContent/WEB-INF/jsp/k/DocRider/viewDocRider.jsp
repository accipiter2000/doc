...
<title><spring:message code="view" /><spring:message code="DOC_RIDER" /></title>
...
<script>
	...
	Ext.onReady(function() {
		...
		var docRiderStore = Ext.create('Ext.data.Store', {//表格数据
			...
			pageSize : 20,
			fields : [ 'DOC_RIDER_ID_', 'DOC_ID_', 'DOC_RIDER_FILE_', 'DOC_RIDER_FILE_NAME_', 'DOC_RIDER_FILE_LENGTH_', 'CREATION_DATE_', 'UPDATE_DATE_', 'OPERATOR_ID_', 'OPERATOR_NAME_' ],
			proxy : {
	...
	function _loadDocRiderFile(DOC_RIDER_ID_) {
