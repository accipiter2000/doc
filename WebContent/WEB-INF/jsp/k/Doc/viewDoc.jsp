	...
	Ext.onReady(function() {
		...
		var tabPanel = Ext.create('Ext.tab.Panel', {//tab
			...
			items : [ {
				...
				layout : 'fit',
				html : '<iframe src="viewDocBasicInfo.do?DOC_ID_=' + DOC_ID_ + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
			}, {
				title : '<spring:message code="DOC_DATA" />',
				layout : 'fit',
				html : '<iframe src="viewDocData.do?DOC_ID_=' + DOC_ID_ + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
			}, {
				id : 'docFile',
				title : '用Word查看',
				layout : 'fit'
				...
				layout : 'fit',
				html : '<iframe src="viewDocRider.do?DOC_ID_=' + DOC_ID_ + '&hideButtonPanel=true" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
			}, {
				title : '<spring:message code="APPROVAL_MEMO" />',
				layout : 'fit',
				hidden : (doc.PROC_ID_) ? false : true,
				html : '<iframe src="viewApprovalMemo.do?PROC_ID_=' + doc.PROC_ID_ + '&hideButtonPanel=true" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
			}, {
				title : '<spring:message code="PROC_DIAGRAM" />',
				layout : 'fit',
				html : '<iframe src="viewRunningProcDiagram.do?PROC_ID_=' + doc.PROC_ID_ + '&hideButtonPanel=true" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
			} ],
			listeners : {
