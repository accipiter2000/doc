...
<title><spring:message code="update" /><spring:message code="DOC.TEMPLATE_FILE" /></title>
...
<script>
	...
	Ext.onReady(function() {
		...
		var docFormPanel = Ext.create('Ext.form.Panel', {//表单
			...
			items : [ {
				...
				xtype : 'filefield',
				name : 'TEMPLATE_FILE_',
				fieldLabel : '<spring:message code="DOC.TEMPLATE_FILE_" />',
					...
					listeners : {
						'render' : function(cmp, eOpts) {
							Ext.create('Ext.tip.ToolTip', {
								target : cmp.getEl(),
								dismissDelay : 60000,
								html : '<spring:message code="update" /><spring:message code="DOC" /><br /><br /><spring:message code="help.updateDocHtml" />'
							});
						}
					}
				} ],
	...
	function _updateTemplateFile() {//修改
		Ext.getCmp('docFormPanel').getForm().submit({//提交表单
			url : 'updateDocTemplateFile.do',
