...
<script>
		...
		var docPanel = Ext.create('Ext.grid.Panel', {//表格
			...
			dockedItems : [ {
				...
				items : [ {
					...
					xtype : 'button',
					text : '<spring:message code="update" /><spring:message code="DOC.TEMPLATE_FILE_" />',
					icon : 'image/icon/update.png',
					handler : _preUpdateTemplateFile
				}, {
					xtype : 'button',
					text : '<spring:message code="update" /><spring:message code="DOC.HTML_" />',
					icon : 'image/icon/update.png',
					handler : _preUpdateHtml
				}, {
					xtype : 'button',
					text : '<spring:message code="update" /><spring:message code="DOC.INDEX_" />',
					icon : 'image/icon/update.png',
					handler : _preUpdateIndex
				}, {
					xtype : 'button',
	...
	function _preUpdateTemplateFile() {
		...
		win = Ext.create('Ext.window.Window', {
			title : '<spring:message code="update" /><spring:message code="DOC.TEMPLATE_FILE_" />',
			modal : true,
			autoShow : true,
			maximized : false,
			maximizable : true,
			width : 800,
			height : '80%',
			html : '<iframe src="preUpdateDocTemplateFile.do?DOC_ID_=' + records[0].get('DOC_ID_') + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
		});
	}

	function _preUpdateHtml() {
		var records = Ext.getCmp('docPanel').getSelectionModel().getSelection();
		...
		returnValue = null;
		win = Ext.create('Ext.window.Window', {
			title : '<spring:message code="update" /><spring:message code="DOC.HTML_" />',
			modal : true,
			autoShow : true,
			maximized : false,
			maximizable : true,
			width : 800,
			height : '80%',
			html : '<iframe src="preUpdateDocHtml.do?DOC_ID_=' + records[0].get('DOC_ID_') + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
		});
	}

	function _preUpdateIndex() {
		var records = Ext.getCmp('docPanel').getSelectionModel().getSelection();
		...
		returnValue = null;
		win = Ext.create('Ext.window.Window', {
			title : '<spring:message code="update" /><spring:message code="DOC.INDEX_" />',
			modal : true,
			autoShow : true,
			maximized : false,
			maximizable : true,
			width : 800,
			height : '80%',
			html : '<iframe src="preUpdateDocIndex.do?DOC_ID_=' + records[0].get('DOC_ID_') + '" style="width: 100%; height: 100%;" frameborder="0"></iframe>'
		});
	}
