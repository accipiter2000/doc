...
public class CodeServiceImpl implements CodeService {
    ...
    public int moveCode(String CODE_ID_, String PARENT_CODE_ID_) {
        String sql = "update CB_CODE set PARENT_CODE_ID_ = ? where CODE_ID_ = ? and not exists (select 1 from CB_CODE where CODE_ID_ = ? connect by prior CODE_ID_ = PARENT_CODE_ID_ start with CODE_ID_ = ?)";
        return msJdbcTemplate.update(sql, PARENT_CODE_ID_, CODE_ID_, PARENT_CODE_ID_, CODE_ID_);
    }
