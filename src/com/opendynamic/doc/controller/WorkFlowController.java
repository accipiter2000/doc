...
public class WorkFlowController extends OdController {
    ...
    @ResponseBody
    public Map<String, Object> selectProcDef(String PROC_DEF_ID_, @RequestParam(value = "PROC_DEF_ID_LIST", required = false) List<String> PROC_DEF_ID_LIST, String PROC_DEF_CODE_, @RequestParam(value = "PROC_DEF_CODE_LIST", required = false) List<String> PROC_DEF_CODE_LIST, String PROC_DEF_NAME_, @RequestParam(value = "PROC_DEF_NAME_LIST", required = false) List<String> PROC_DEF_NAME_LIST, String PROC_DEF_CAT_, @RequestParam(value = "PROC_DEF_CAT_LIST", required = false) List<String> PROC_DEF_CAT_LIST, String EXT_ATTR_1_, @RequestParam(value = "EXT_ATTR_1_LIST", required = false) List<String> EXT_ATTR_1_LIST, String EXT_ATTR_2_, @RequestParam(value = "EXT_ATTR_2_LIST", required = false) List<String> EXT_ATTR_2_LIST, String EXT_ATTR_3_,
            @RequestParam(value = "EXT_ATTR_3_LIST", required = false) List<String> EXT_ATTR_3_LIST, String EXT_ATTR_4_, @RequestParam(value = "EXT_ATTR_4_LIST", required = false) List<String> EXT_ATTR_4_LIST, String EXT_ATTR_5_, @RequestParam(value = "EXT_ATTR_5_LIST", required = false) List<String> EXT_ATTR_5_LIST, String EXT_ATTR_6_, @RequestParam(value = "EXT_ATTR_6_LIST", required = false) List<String> EXT_ATTR_6_LIST, String EXT_ATTR_7_, @RequestParam(value = "EXT_ATTR_7_LIST", required = false) List<String> EXT_ATTR_7_LIST, String EXT_ATTR_8_, @RequestParam(value = "EXT_ATTR_8_LIST", required = false) List<String> EXT_ATTR_8_LIST, Integer VERSION_, @RequestParam(value = "VERSION_LIST", required = false) List<Integer> VERSION_LIST, String PROC_DEF_STATUS_,
            @RequestParam(value = "PROC_DEF_STATUS_LIST", required = false) List<String> PROC_DEF_STATUS_LIST, Integer page, Integer limit, Map<String, Object> operator) {
        Map<String, Object> result = new HashMap<>();

        List<Map<String, Object>> procDefList = ffProcDefService.selectProcDef(PROC_DEF_ID_, PROC_DEF_ID_LIST, PROC_DEF_CODE_, PROC_DEF_CODE_LIST, PROC_DEF_NAME_, PROC_DEF_NAME_LIST, PROC_DEF_CAT_, PROC_DEF_CAT_LIST, EXT_ATTR_1_, EXT_ATTR_1_LIST, EXT_ATTR_2_, EXT_ATTR_2_LIST, EXT_ATTR_3_, EXT_ATTR_3_LIST, EXT_ATTR_4_, EXT_ATTR_4_LIST, EXT_ATTR_5_, EXT_ATTR_5_LIST, EXT_ATTR_6_, EXT_ATTR_6_LIST, EXT_ATTR_7_, EXT_ATTR_7_LIST, EXT_ATTR_8_, EXT_ATTR_8_LIST, VERSION_, VERSION_LIST, PROC_DEF_STATUS_, PROC_DEF_STATUS_LIST, page, limit);
        int total = 0;
        if (limit != null && limit > 0) {
            total = ffProcDefService.countProcDef(PROC_DEF_ID_, PROC_DEF_ID_LIST, PROC_DEF_CODE_, PROC_DEF_CODE_LIST, PROC_DEF_NAME_, PROC_DEF_NAME_LIST, PROC_DEF_CAT_, PROC_DEF_CAT_LIST, EXT_ATTR_1_, EXT_ATTR_1_LIST, EXT_ATTR_2_, EXT_ATTR_2_LIST, EXT_ATTR_3_, EXT_ATTR_3_LIST, EXT_ATTR_4_, EXT_ATTR_4_LIST, EXT_ATTR_5_, EXT_ATTR_5_LIST, EXT_ATTR_6_, EXT_ATTR_6_LIST, EXT_ATTR_7_, EXT_ATTR_7_LIST, EXT_ATTR_8_, EXT_ATTR_8_LIST, VERSION_, VERSION_LIST, PROC_DEF_STATUS_, PROC_DEF_STATUS_LIST);
        }
    ...
    public Map<String, Object> undoOperation(String OPERATION_ID_, Map<String, Object> operator) {
        ...
        for (Proc deleteProc : deleteProcList) {
            docService.updateProcStatus(deleteProc.getBizId(), "0");
        }
        List<Proc> activateProcList = ffResult.getActivateProcList();
        for (Proc activateProc : activateProcList) {
            docService.updateProcStatus(activateProc.getBizId(), "1");
        }
