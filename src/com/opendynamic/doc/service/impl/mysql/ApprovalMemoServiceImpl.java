...
public class ApprovalMemoServiceImpl implements ApprovalMemoService {
    ...
    private OdSqlCriteria buildSqlCriteriaApprovalMemo(boolean count, String APPROVAL_MEMO_ID_, String TASK_ID_, String NODE_ID_, String NODE_TYPE_, String PROC_ID_, String BIZ_ID_, String ASSIGNEE_, String ASSIGNEE_CODE_, String ASSIGNEE_NAME_, String EXECUTOR_, String EXECUTOR_CODE_, String EXECUTOR_NAME_, String ORG_ID_, String COM_ID_, Date FROM_CREATION_DATE_, Date TO_CREATION_DATE_, Date FROM_DUE_DATE_, Date TO_DUE_DATE_, Integer APPROVAL_MEMO_TYPE_, Date FROM_APPROVAL_DATE_, Date TO_APPROVAL_DATE_, List<String> APPROVAL_MEMO_STATUS_LIST) {// 组装查询SQL语句
        ...
        if (StringUtils.isNotEmpty(APPROVAL_MEMO_ID_)) {
        ...
        if (StringUtils.isNotEmpty(COM_ID_)) {
        ...
        if (APPROVAL_MEMO_STATUS_LIST != null && APPROVAL_MEMO_STATUS_LIST.size() > 0) {
    ...
    public List<Map<String, Object>> selectApprovalMemoByIdList(List<String> APPROVAL_MEMO_ID_LIST) {
        if (APPROVAL_MEMO_ID_LIST == null || APPROVAL_MEMO_ID_LIST.size() == 0) {
        ...
        sql.append(" order by FIELD(APPROVAL_MEMO_ID_,");// 按主键列表顺序排序
        for (int i = 0; i < APPROVAL_MEMO_ID_LIST.size(); i++) {
            sql.append(" '").append(APPROVAL_MEMO_ID_LIST.get(i)).append("'");
    ...
    public int insertApprovalMemo(String APPROVAL_MEMO_ID_, String TASK_ID_, String PREVIOUS_TASK_ID_, String NODE_ID_, String NODE_TYPE_, String NODE_NAME_, String PARENT_NODE_ID_, String PROC_ID_, String BIZ_ID_, String ASSIGNEE_, String ASSIGNEE_CODE_, String ASSIGNEE_NAME_, String EXECUTOR_, String EXECUTOR_CODE_, String EXECUTOR_NAME_, String ORG_ID_, String ORG_NAME_, String COM_ID_, String COM_NAME_, Date CREATION_DATE_, Date DUE_DATE_, String APPROVAL_MEMO_TYPE_, String APPROVAL_MEMO_, Date APPROVAL_DATE_, String APPROVAL_MEMO_STATUS_, String BIZ_NAME_, String FORWARD_URL_, String OPERATION_ID_) {
        ...
        int count = msJdbcTemplate.update(sql, APPROVAL_MEMO_ID_, TASK_ID_, PREVIOUS_TASK_ID_, NODE_ID_, NODE_TYPE_, NODE_NAME_, PARENT_NODE_ID_, PROC_ID_, BIZ_ID_, ASSIGNEE_, ASSIGNEE_CODE_, ASSIGNEE_NAME_, EXECUTOR_, EXECUTOR_CODE_, EXECUTOR_NAME_, ORG_ID_, ORG_NAME_, COM_ID_, COM_NAME_, CREATION_DATE_, DUE_DATE_, APPROVAL_MEMO_TYPE_, APPROVAL_MEMO_, APPROVAL_DATE_, APPROVAL_MEMO_STATUS_, OPERATION_ID_);

        // 发送即时通
        String NOTICE_ID_ = OdUtils.getUuid();
        String IDENTITY_ = OdUtils.getUuid();
        String REDIRECT_URL_ = OdConfig.getServer() + "redirectNotice.do?IDENTITY_=" + IDENTITY_;
        String CONTENT_ = "您有一个新的待办任务: " + BIZ_NAME_;

        if (NODE_TYPE_ != null && NODE_TYPE_.equals("TASK") && !FfService.USER_FF_SYSTEM.equals(EXECUTOR_)) {
            noticeService.insertNotice(NOTICE_ID_, ASSIGNEE_, null, ASSIGNEE_CODE_, ASSIGNEE_NAME_, CONTENT_, "WORKFLOW", IDENTITY_, REDIRECT_URL_, FORWARD_URL_, null, "0", new Date());
        }
    ...
    public int insertApprovalMemo(String APPROVAL_MEMO_ID_, String TASK_ID_, String PREVIOUS_TASK_ID_, String NODE_ID_, String NODE_TYPE_, String NODE_NAME_, String PARENT_NODE_ID_, String PROC_ID_, String BIZ_ID_, String ASSIGNEE_, String ASSIGNEE_CODE_, String ASSIGNEE_NAME_, String EXECUTOR_, String EXECUTOR_CODE_, String EXECUTOR_NAME_, String ORG_ID_, String ORG_NAME_, String COM_ID_, String COM_NAME_, Date CREATION_DATE_, Date DUE_DATE_, String APPROVAL_MEMO_TYPE_, String APPROVAL_MEMO_, Date APPROVAL_DATE_, String APPROVAL_MEMO_SOURCE_, String APPROVAL_MEMO_STATUS_, String BIZ_NAME_, String FORWARD_URL_, String OPERATION_ID_) {
        String sql = "insert into K_APPROVAL_MEMO (APPROVAL_MEMO_ID_, TASK_ID_, PREVIOUS_TASK_ID_, NODE_ID_, NODE_TYPE_, NODE_NAME_, PARENT_NODE_ID_, PROC_ID_, BIZ_ID_, ASSIGNEE_, ASSIGNEE_CODE_, ASSIGNEE_NAME_, EXECUTOR_, EXECUTOR_CODE_, EXECUTOR_NAME_, ORG_ID_, ORG_NAME_, COM_ID_, COM_NAME_, CREATION_DATE_, DUE_DATE_, APPROVAL_MEMO_TYPE_, APPROVAL_MEMO_, APPROVAL_DATE_, APPROVAL_MEMO_SOURCE_, APPROVAL_MEMO_STATUS_, OPERATION_ID_) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        int count = msJdbcTemplate.update(sql, APPROVAL_MEMO_ID_, TASK_ID_, PREVIOUS_TASK_ID_, NODE_ID_, NODE_TYPE_, NODE_NAME_, PARENT_NODE_ID_, PROC_ID_, BIZ_ID_, ASSIGNEE_, ASSIGNEE_CODE_, ASSIGNEE_NAME_, EXECUTOR_, EXECUTOR_CODE_, EXECUTOR_NAME_, ORG_ID_, ORG_NAME_, COM_ID_, COM_NAME_, CREATION_DATE_, DUE_DATE_, APPROVAL_MEMO_TYPE_, APPROVAL_MEMO_, APPROVAL_DATE_, APPROVAL_MEMO_SOURCE_, APPROVAL_MEMO_STATUS_, OPERATION_ID_);
        return count;
    }
    ...
    public int deleteLastApprovalMemoByTaskId(String TASK_ID_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        List<Map<String, Object>> approvalMemoList = selectApprovalMemo(null, TASK_ID_, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 1, -1);

        if (approvalMemoList.size() > 0) {
            String sql = "delete from K_APPROVAL_MEMO where APPROVAL_MEMO_ID_ = ?";
    ...
    public int deleteLastApprovalMemoByNodeId(String NODE_ID_, String NODE_TYPE_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        List<Map<String, Object>> approvalMemoList = selectApprovalMemo(null, null, NODE_ID_, NODE_TYPE_, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 1, -1);
