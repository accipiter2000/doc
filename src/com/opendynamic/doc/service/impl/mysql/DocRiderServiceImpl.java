...
public class DocRiderServiceImpl implements DocRiderService {
    ...
    @Override
    public List<Map<String, Object>> selectDocRider(String DOC_RIDER_ID_, String DOC_ID_, Integer page, Integer limit) {
        OdSqlCriteria odSqlCriteria = buildSqlCriteriaDocRider(false, DOC_RIDER_ID_, DOC_ID_);// 根据查询条件组装查询SQL语句
    ...
    @Override
    public int countDocRider(String DOC_RIDER_ID_, String DOC_ID_) {
        OdSqlCriteria odSqlCriteria = buildSqlCriteriaDocRider(true, DOC_RIDER_ID_, DOC_ID_);// 根据查询条件组装总数查询SQL语句
        String sql = odSqlCriteria.getSql();
        Map<String, Object> paramMap = odSqlCriteria.getParamMap();
    ...
    private OdSqlCriteria buildSqlCriteriaDocRider(boolean count, String DOC_RIDER_ID_, String DOC_ID_) {// 组装查询SQL语句
        String sql;
    ...
    public List<Map<String, Object>> selectDocRiderByIdList(List<String> DOC_RIDER_ID_LIST) {
        if (DOC_RIDER_ID_LIST == null || DOC_RIDER_ID_LIST.isEmpty()) {
        ...
        sql.append(" order by FIELD(DOC_RIDER_ID_,");// 按主键列表顺序排序
        for (int i = 0; i < DOC_RIDER_ID_LIST.size(); i++) {
            sql.append(" '").append(DOC_RIDER_ID_LIST.get(i)).append("'");
    ...
    public int updateDocRider(String DOC_RIDER_ID_, InputStream DOC_RIDER_FILE_, String DOC_RIDER_FILE_NAME_, Integer DOC_RIDER_FILE_LENGTH_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        String sql = "update K_DOC_RIDER set DOC_RIDER_ID_ = :DOC_RIDER_ID_";
    ...
    public int deleteDocRider(String DOC_RIDER_ID_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        String sql = "delete from K_DOC_RIDER where DOC_RIDER_ID_ = ?";
    ...
    public int deleteDocRiderByDocId(String DOC_ID_, Date UPDATE_DATE_, String OPERATOR_ID_, String OPERATOR_NAME_) {
        List<Map<String, Object>> docRiderList = selectDocRider(null, DOC_ID_, 1, -1);
