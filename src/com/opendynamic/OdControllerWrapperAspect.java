...
public class OdControllerWrapperAspect {
    ...
    public Object wrapper(ProceedingJoinPoint point) throws Throwable {
        ...
        String contentType = request.getContentType();// 如果Content-Type为application/json,取bean的toString
        if (contentType != null) {
            ...
            if (contentType.startsWith("application/json")) {
                ...
                for (int i = 0; i < arguments.length; i++) {
                    if (arguments[i] != null) {
                        stringBuilder.append(arguments[i].toString()).append("\r\n");
                    }
                }
                PARAMETER_MAP_ = stringBuilder.toString();
            }
        }
